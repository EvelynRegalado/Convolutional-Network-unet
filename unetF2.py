...
TRAIN_PATH = '/home/evelyn/Escritorio/unet_kaggle/stage1_trainold/'
TEST_PATH = '/home/evelyn/Escritorio/unet_kaggle/stage1_testold/'
...
results = model.fit(X_train, Y_train, validation_split=0.1, batch_size=32, epochs=epochs, callbacks=[earlystopper, checkpointer])
...
#pred= np.shape(preds_test, (preds_test.shape[0]))
#X_test /= 255.0
